...
public class BannerApiController extends ApiController {
    ...
    private List<Banner> getBanners(@RequestParam(value = "bannerType", required = false, defaultValue = Constant.BANNER_MAIN + "") int  bannerType, HttpServletRequest request) {
